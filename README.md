...
| `PORTUNUS_SLAPD_TLS_CA_BUNDLE` | `/etc/ssl/certs/ca-certificates.crt` | A bundle of root CA certificates, one of which must have signed the TLS certificate (if given). |
